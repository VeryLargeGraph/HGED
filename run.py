...
@click.option('--lambdax', prompt='Lambda(float)', help='The value of the parameter Lambda')
@click.option('--method', prompt='Type one number to chose the algorithm: [1]HEP-JS; [2]HEP-DFS; [3]HEP-BFS. (int)',
              help='Three stable community detection methods')
